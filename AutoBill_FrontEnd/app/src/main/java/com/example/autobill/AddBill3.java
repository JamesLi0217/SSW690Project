...
public class AddBill3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_bill3);
        BillName = findViewById(R.id.bill3_name);
        BillAmount = findViewById(R.id.bill3_amount);
        BillDate = findViewById(R.id.bill3_date);
        BillReceipt = findViewById(R.id.bill3_receipt);
        BillDecription = findViewById(R.id.bill3_desciption);
        BillParticipant = findViewById(R.id.bill3_participant);
        BillPayer = findViewById(R.id.bill3_payer);
        mBtnCancle = findViewById(R.id.bill3_cancle);
        mBtnCancle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddBill3.this, Bill3.class);
                startActivity(intent);
                Toast.makeText(getApplicationContext(), "Bill Has Been Caneclled ", Toast.LENGTH_SHORT).show();

            }
        });
        mBtnConfirm = findViewById(R.id.bill3_confirm);
