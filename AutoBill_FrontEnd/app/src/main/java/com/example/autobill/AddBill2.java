...
public class AddBill2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BillName = findViewById(R.id.bill2_name);
        BillAmount = findViewById(R.id.bill2_amount);
        BillDate = findViewById(R.id.bill2_date);
        BillReceipt = findViewById(R.id.bill2_receipt);
        BillDecription = findViewById(R.id.bill2_desciption);
        BillParticipant = findViewById(R.id.bill2_participant);
        BillPayer = findViewById(R.id.bill2_payer);
        mBtnCancle = findViewById(R.id.bill2_cancle);
        mBtnCancle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddBill2.this, Bill2.class);
                startActivity(intent);
                Toast.makeText(getApplicationContext(), "Bill Has Been Caneclled ", Toast.LENGTH_SHORT).show();

            }
        });
        mBtnConfirm = findViewById(R.id.bill2_confirm);
