...
public class AddBill1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_bill1);
        BillName = findViewById(R.id.bill1_name);
        BillAmount = findViewById(R.id.bill1_amount);
        BillDate = findViewById(R.id.bill1_date);
        BillReceipt = findViewById(R.id.bill1_receipt);
        BillDecription = findViewById(R.id.bill1_desciption);
        BillParticipant = findViewById(R.id.bill1_participant);
        BillPayer = findViewById(R.id.bill1_payer);
        mBtnCancle = findViewById(R.id.bill1_cancle);
        mBtnCancle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddBill1.this, Bill1.class);
                startActivity(intent);
                Toast.makeText(getApplicationContext(), "Bill Has Been Caneclled ", Toast.LENGTH_SHORT).show();

            }
        });
        mBtnConfirm = findViewById(R.id.bill1_confirm);
